...
- **Frontend unit tests cover the pure logic modules, not components.** vitest
  ...
  `fileSearch`, `fileTabs`, `filesTreeWidth`, `inboxFilter`, `inboxRead`, `keyboardScope`,
  `lastView`, `layout`, `markdownAssets`, `modalDrag`, `navCollapse`, `navOrder`,
