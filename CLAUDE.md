...
- **Frontend unit tests cover the pure logic modules, not components.** vitest
  ...
  `keyboardScope`,
  `lastView`, `layout`, `liveCapture`, `livePromptDraft`, `liveRecognition`,
  `liveSession`,
  `liveTurns`,
