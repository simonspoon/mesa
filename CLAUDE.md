...
- **Frontend unit tests cover the pure logic modules, not components.** vitest
  ...
  `keyboardScope`,
  `lastView`, `layout`, `libraryDraft`, `librarySync`, `liveCapture`, `liveContext`, `liveDevices`, `liveIndicator`, `livePromptDraft`,
  `liveRecognition`,
  `liveSession`,
  `liveTurns`,
  `liveWindow`,
