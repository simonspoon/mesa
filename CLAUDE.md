...
- **Exit codes are load-bearing:** 0 success, 1 domain/runtime error, 2 usage
  ...
  routes (the `kokoro-rs` binary may be missing or fail) and `live look` (the
